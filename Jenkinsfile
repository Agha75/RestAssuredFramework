pipeline {
    ...
    post{
        always{
            emailext body: 'Please go to ${BUILD_URL} and verify the build send from scriptive', subject: 'Job '${JOB_NAME}' (${BUILD_NUMBER}) is waiting for input', to: 'jenkinsjob123@gmail.com'
        }
    }
}
